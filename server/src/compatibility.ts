...
export const COMPATIBILITY_PROFILES: Record<BitcoinCoreVersion, CompatibilityProfile> = {
  '30.2': {
    ...
    status: 'supported',
    images: {
      jdc: 'stratumv2/jd_client_sv2:v0.3.4',
      translator: 'stratumv2/translator_sv2:v0.3.4',
    },
    monitoringApi: {
      jdc: '/api/v1',
      translator: '/api/v1',
  ...
  '31.0': {
    ...
    status: 'wip',
    images: {
      // Release branches must replace these temporary main tags with the latest
      // released sv2-apps image versions compatible with Bitcoin Core 31.0.
