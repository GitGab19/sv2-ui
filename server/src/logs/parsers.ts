...
const JDC_BITCOIN_CORE_UNSUPPORTED_MINING_INTERFACE_REGEX =
  /Failed to create BitcoinCoreToSv2: CapnpError\(Error \{ kind: Failed, extra: "remote exception: std::exception: Old mining interface \(@\d+\) not supported\. Please update your client!" \}\)/;
